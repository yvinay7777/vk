...
export default function ResumePage({ user, resume, setResume, savedJobs }) {
  ...
  return (
    <div className="space-y-10 py-6">
      ...
      <div>
        ...
        <p className="text-slate-300 text-sm mt-1">Upload and manage your credentials to map career paths.</p>
      </div>
      ...
      <div className="grid gap-8 xl:grid-cols-[1fr_2fr]">
        ...
        <div>
          <DashboardPanel resume={resume} savedJobs={savedJobs} />
        </div>
      </div>
